...
export default function Grainient({
  ...
  useEffect(() => {
    ...
    function update(t) {
      ...
      program.uniforms.uCenterOffset.value = [centerX, centerY];
      program.uniforms.uZoom.value = zoom;
      program.uniforms.uColor1.value = hexToRgb(color1);
      program.uniforms.uColor2.value = hexToRgb(color2);
      program.uniforms.uColor3.value = hexToRgb(color3);
