...
export default function Navbar() {
  ...
  return (
    <>
      {/* Inject scoped nav styles using CSS variables */}
      <style>{`
        .nav-sidebar {
          width: 240px;
          min-width: 240px;
        ...
        .nav-brand-title { font-size: 16px; font-weight: 800; color: var(--sidebar-text); letter-spacing: -0.3px; transition: color 0.25s ease; }
        .nav-brand-accent { font-size: 16px; font-weight: 900; color: #2563eb; letter-spacing: -0.3px; }
        .nav-brand-sub { font-size: 10.5px; font-weight: 500; color: var(--sidebar-muted); margin-top: 1px; transition: color 0.25s ease; }
        .nav-section-label {
        ...
        .nav-icon { display: flex; align-items: center; flex-shrink: 0; transition: color 0.15s ease; }
        ...
        .nav-status-text { font-size: 12px; font-weight: 600; color: var(--status-text); transition: color 0.25s ease; }
        .nav-status-sub { font-size: 11px; color: var(--status-sub); margin-top: 2px; transition: color 0.25s ease; }
        .nav-live-badge {
        ...
        <div className="nav-brand-border">
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: '1px' }}>
              <span className="nav-brand-title">Timetable</span>
          ...
          <div className="nav-status-card">
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '3px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
                ...
                <span className="nav-status-text">System ready</span>
              </div>
